...
pub async fn create_dashboard(
    ...
    let service = DashboardService::new(db);
    match service.create_dashboard(connection_id, payload.name, payload.description).await {
...
pub async fn add_chart(
    ...
    let service = DashboardService::new(db);
    match service.add_chart(dashboard_id, payload.saved_query_id, payload.name, payload.chart_type, payload.config, payload.layout).await {
