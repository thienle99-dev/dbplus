...
export default function CommandPalette({ isOpen, onClose, connectionId }: CommandPaletteProps) {
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[15vh]">
      ...
      <div className="relative w-full max-w-xl bg-bg-1/60 backdrop-blur-2xl rounded-md shadow-2xl border border-white/10 flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-100 ring-1 ring-white/5">
